...
TABLE: sector_mappings
  ...
  - sector TEXT (e.g. "Technology", "Financials", "Energy"; default "Unspecified" for unmapped symbols)

RELATIONSHIPS:
- positions.account_id → accounts.id
- sector_mappings.symbol → positions.symbol (LEFT JOIN to include unmapped symbols)
